...
export default function AllStudents() {
  ...
  const fetchStudents = async (token) => {
    setLoading(true);
    try {
      const response = await axios.get(EndPoint + "/students_by_role/", {
        headers: {
  ...
  const openBehaviour = (student) => {
    router.push({
      pathname: "/(Screens)/get-student.behaviour",
      params: {
  ...
  return (
    ...
    >
      ...
      <ScrollView
        contentContainerStyle={{ padding: 12, paddingBottom: 250 }}
      ...
      >
          ...
          <View style={{ marginTop: 22 }}>
            <View style={{
              ...
              <TextInput
                ...
                placeholder={language === "sw" ? "Tafuta mwanafunzi au namba ya usajili..." : "Search student or admission number..."}
        ...
        {filteredStudents.length === 0 && !loading && (
          <View style={{
            ...
            <Ionicons name="people-outline" size={55} color="#64748b" />
            <Text style={{ color: "#e2e8f0", fontSize: 17, fontWeight: "700", marginTop: 15 }}>
              {language === "sw" ? "Hakuna Wanafunzi" : "No Students Found"}
            </Text>
            <Text style={{ color: "#94a3b8", marginTop: 8, textAlign: "center", lineHeight: 22 }}>
              {language === "sw" ? "Hakuna wanafunzi waliofanana na utafutaji wako" : "No students matched your current search"}
            </Text>
          </View>
        )}
                    ...
                    <View style={{ flex: 1, marginLeft: 15 }}>
                      ...
                      <View style={{ flexDirection: "row", alignItems: "center", marginTop: 7 }}>
                        ...
                        <Text style={{ color: "#94a3b8", fontSize: 13, marginLeft: 6 }}>
                          {language === "sw" ? "Namba ya Usajili:" : "Admission No:"} {item.admission_number}
                        </Text>
                      </View>
                  ...
                  <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                      <View style={{
                        ...
                        <Ionicons name="happy-outline" size={20} color="#38bdf8" />
                      </View>
                      <View style={{ marginLeft: 10 }}>
                        <Text style={{ color: "#ffffff", fontWeight: "700", fontSize: 14 }}>
                          {language === "sw" ? "Rekodi za Tabia" : "Behaviour Records"}
                        </Text>
                        <Text style={{ color: "#94a3b8", fontSize: 12, marginTop: 2 }}>
                          {language === "sw" ? "Tazama historia ya tabia" : "View student behaviour history"}
                        </Text>
                      </View>
                    </View>

                    <TouchableOpacity onPress={() => openBehaviour(item)} activeOpacity={0.85}>
                      <LinearGradient
                        colors={["#2563eb", "#38bdf8"]}
                        style={{ paddingHorizontal: 18, paddingVertical: 12, borderRadius: 14, flexDirection: "row", alignItems: "center" }}
                      >
