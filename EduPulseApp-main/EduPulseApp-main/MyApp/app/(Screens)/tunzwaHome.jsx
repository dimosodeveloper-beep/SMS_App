...
export default function Home() {
  ...
  const { userData } = useContext(UserContext); // 🔥 Get logged-in user

  const stats = [
    { id: 1, title: "Results", value: 1245, icon: "people", route: "/(Screens)/results-homepage", percentage: 75 },
    { id: 2, title: "Attendance", value: 86, icon: "school", route: "/(Screens)/attendance-homepage", percentage: 86 },
    { id: 3, title: "Exams", value: 32, icon: "class", route: "/(Screens)/exams-homepage", percentage: 60 },
    { id: 4, title: "Students", value: 18, icon: "menu-book", route: "/(Screens)/students-homepage", percentage: 45 },
  ];

  const actions = [
    { id: 1, title: "All Subjects", icon: "user-plus", route: "/(Screens)/all-subjects" },
      ...
      >
        ...
        <View style={styles.heroContainer}>
          ...
          <View style={styles.heroOverlay}>
            ...
            <View style={styles.heroButtons}>
              {/* 🔥 Changed buttons to Welcome & username */}
        ...
        <View style={styles.statsContainer}>
          {stats.map((item, index) => (
            <AnimatedCard key={item.id} onPress={() => router.push(item.route)} index={index} percentage={item.percentage}>
